...
def insert_data(path):
    ...
    data=pd.read_csv(path,header=0, names=headers,index_col=False)
    data=data[-500:]
...
with DAG('Data warehouse tech-stack',
    ...
    populate_db = PythonOperator(
            ...
            op_kwargs={
                'url':'.data/I80_davis.txt',
                }
            )

# The actual workflow
create_schema >> populate_db